...
# Script 02: Level 2 Synthetic Data Analysis
...
# ============================================================
survey_path <- "C:/Users/[username]/Downloads/Synthetic_SAVE_Admin_Proxy_Level2/Synthetic_SAVE_Admin_Proxy_Level2/synthetic_household_and_consumption_data_level_2/save_household_survey_data/save_household_survey_data.csv"

elec_folder <- "C:/Users/[username]/Downloads/Synthetic_SAVE_Admin_Proxy_Level2/Synthetic_SAVE_Admin_Proxy_Level2/synthetic_household_and_consumption_data_level_2/save_consumption_data_2018_2_v0-1/"

# ============================================================
# STEP 1 — LOAD SURVEY DATA
# ============================================================
cat("Loading Level 2 survey data...\n")
...
# ============================================================
cat("\n========================================\n")
cat("DESCRIPTIVE ANALYSIS — LEVEL 2\n")
cat("========================================\n")
...
# ============================================================
  cat("\n========================================\n")
  cat("PREDICTIVE ANALYSIS — LEVEL 2\n")
  cat("========================================\n")
...
# ============================================================
  ...
  ggplot(g1, aes(x = factor(Intervention),
                 y = avg_kwh,
                 fill = factor(Intervention))) +
    geom_bar(stat = "identity") +
    labs(title = "Level 2: Energy by Trial Group",
  ...
  ggsave("Graphs/Level2/L2_graph1_trial_group.png",
         width = 8, height = 5)
  cat("Graph 1 saved!\n")
  ...
  ggplot(g2, aes(x = factor(quartile),
                 y = avg_kwh,
                 fill = factor(quartile))) +
    geom_bar(stat = "identity") +
    labs(title = "Level 2: Energy by Deprivation",
         subtitle = "December 2018",
         x = "IMD Quartile",
         y = "Average kWh",
         fill = "Quartile") +
  ...
  ggsave("Graphs/Level2/L2_graph2_deprivation.png",
         width = 8, height = 5)
  cat("Graph 2 saved!\n")
  ...
  ggplot(g3, aes(x = Location,
                 ...
                 fill = Location)) +
    geom_bar(stat = "identity") +
    labs(title = "Level 2: Energy Urban vs Rural",
         subtitle = "December 2018",
         x = "Location",
         y = "Average kWh",
         fill = "Location") +
  ...
  ggsave("Graphs/Level2/L2_graph3_urban_rural.png",
         width = 8, height = 5)
  cat("Graph 3 saved!\n")

  cat("\nAll Level 2 graphs saved!\n")
}

cat("\n========================================\n")
cat("LEVEL 2 ANALYSIS COMPLETE!\n")
cat("========================================\n")
