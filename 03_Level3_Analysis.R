...
# Script 03: Level 3 Synthetic Data Analysis
...
# ============================================================
survey_path <- "C:/Users/[username]/Downloads/Synthetic_SAVE_Admin_Proxy_Level3/Synthetic_SAVE_Admin_Proxy_Level3/synthetic_household_level_3/save_household_survey_data/save_household_survey_data.csv"

elec_folder <- "C:/Users/[username]/Downloads/Synthetic_SAVE_Admin_Proxy_Level3/Synthetic_SAVE_Admin_Proxy_Level3/electricity_consumption_data/save_consumption_data_2018_2_v0-1/"

# ============================================================
# STEP 1 — LOAD SURVEY DATA
# ============================================================
cat("Loading Level 3 survey data...\n")
...
cat("\nNOTE: Level 3 match rate expected to be ~24%\n")
cat("This is because synthetic survey IDs do not\n")
cat("fully align with real electricity IDs\n")

# ============================================================
# STEP 5 — DESCRIPTIVE ANALYSIS
# ============================================================
cat("\n========================================\n")
cat("DESCRIPTIVE ANALYSIS — LEVEL 3\n")
cat("========================================\n")
...
# ============================================================
  cat("\n========================================\n")
  cat("PREDICTIVE ANALYSIS — LEVEL 3\n")
  cat("========================================\n")
...
# ============================================================
  ...
  ggplot(g1, aes(x = factor(Intervention),
    ...
    labs(title = "Level 3: Energy by Trial Group",
  ...
  ggsave("Graphs/Level3/L3_graph1_trial_group.png",
         width = 8, height = 5)
  cat("Graph 1 saved!\n")
  ...
  ggplot(g2, aes(x = factor(quartile),
    ...
    geom_bar(stat = "identity") +
    labs(title = "Level 3: Energy by Deprivation",
         subtitle = "December 2018",
         x = "IMD Quartile",
         y = "Average kWh",
         fill = "Quartile") +
  ...
  ggsave("Graphs/Level3/L3_graph2_deprivation.png",
         width = 8, height = 5)
  cat("Graph 2 saved!\n")

  cat("\nAll Level 3 graphs saved!\n")
}

cat("\n========================================\n")
cat("LEVEL 3 ANALYSIS COMPLETE!\n")
cat("========================================\n")
